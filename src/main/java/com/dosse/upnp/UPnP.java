...
public class UPnP {
     ...
     */
    public static boolean openPortTCP(int port, String description) {
        if(!isUPnPAvailable()) return false;
        return defaultGW.openPort(port, false, description);
    }
     ...
     * @return true if the operation was successful, false otherwise
     */
    public static boolean openPortUDP(int port, String description) {
        if(!isUPnPAvailable()) return false;
        return defaultGW.openPort(port, true, description);
    }
